...
Please read [`CONTRIBUTING.md`](CONTRIBUTING.md) before opening a pull request. Planned work is tracked in [GitHub Issues](https://github.com/pietz/ziffer/issues).
