...
## Nachtrag 2026-09-22: Vorsteuer nach Zusammenführung der Entwicklungsstände

- Die Zehn-Prozent-Grenze in [§15 Abs. 1 Satz 2 UStG](https://www.gesetze-im-internet.de/ustg_1980/__15.html) nennt ausdrücklich Gegenstände, einschließlich innergemeinschaftlicher Erwerbe. Für sonstige Leistungen beschreibt [UStAE 15.2c Abs. 2](https://usth.bundesfinanzministerium.de/usth/2023/A-Umsatzsteuergesetz/IV-Steuer-und-Vorsteuer/Paragraf-15/ae-15-2c.html) die anteilige Zuordnung.
- Die frühere Eigentümerentscheidung vom 2026-09-20 gilt weiter: Inlandsbuchungen unterscheiden Ware und Leistung nicht, deshalb nehmen Kz 66 und EÜR-Zeile 58 stets den betrieblichen Anteil. Für inländische Gegenstände unter zehn Prozent bleibt dies eine bekannte Vereinfachung mit manueller Korrektur, keine gesetzliche Ausnahme. §13b-Dienstleistungen bleiben ebenfalls anteilig abziehbar. Die neue explizite EU-Warenbehandlung behält dagegen die gesetzliche Grenze für Kz 61.
- [§24 UStG](https://www.gesetze-im-internet.de/ustg_1980/__24.html) belegt weitere zulässige Rechnungssätze, darunter 7,8 Prozent. Inländische Eingangsrechnungen dürfen deshalb andere ausgewiesene positive Sätze tragen; Pfennigs Inlandseinnahmen sowie Empfängersteuer-Ausgaben bleiben auf die unterstützten 19/7 Prozent begrenzt. Tests sichern den Dezimalsatz durch SQL, UStVA und EÜR sowie die unveränderten Grenzen bei Einnahmen und Erwerb. Kein neuer ELSTER-Testupload.

## Nachtrag 2026-09-25: Zeitpunkt der inländischen Vorsteuer

- [§15 Abs. 1 Satz 1 Nr. 1 UStG](https://www.gesetze-im-internet.de/ustg_1980/__15.html): Vorsteuer ist abziehbar, sobald die Leistung ausgeführt ist und eine ordnungsgemäße Rechnung vorliegt; die Zahlung ist dafür unerheblich. Nur bei Zahlung vor Ausführung der Leistung (Satz 3) kommt es auf die Zahlung und die Rechnung an. Die Ist-Versteuerung nach [§20 UStG](https://www.gesetze-im-internet.de/ustg_1980/__20.html) betrifft nur die Entstehung der Umsatzsteuer.
- Pfennig nimmt Kz 66 für `inland`-Ausgaben deshalb vollständig im Zeitraum des Belegdatums, bezahlt oder nicht; die frühere Regel „Späteres von Beleg- und Zahlungsdatum, je Zahlung“ entfällt. Ohne Leistungsdatum steht das Belegdatum für die Leistung. Unbezahlte Voraus- oder Anzahlungsrechnungen für noch nicht ausgeführte Leistungen zählen damit zu früh und werden manuell korrigiert. EÜR-Zeile 58 folgt weiter dem Abfluss. Rechentests, kein neuer ELSTER-Testupload.
