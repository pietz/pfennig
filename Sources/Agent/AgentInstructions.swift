...
public enum AgentInstructions {
    ...
    Schreibweise. gegenpartei_land und gegenpartei_ustid nimmst du aus dem Rechnungskopf des \
    Ausstellers.
    ...
    Anteil belegt, trägst du ihn ein; vom gekauften Produkt schließt du nie darauf.
    - Was das Dokument nicht hergibt, bleibt leer. Zweifel schreibst du in notizen, nicht in einen \
    geratenen Wert.
    - notizen bleibt normalerweise leer; schreibe nur kurze Zusatzinformationen ohne eigenes Feld sowie \
    dokumentbezogene Besonderheiten oder Unsicherheiten, etwa eine Rechnungsnummer, und wiederhole keine \
    Buchungsdaten.
