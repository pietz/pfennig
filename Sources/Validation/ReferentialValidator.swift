...
public enum ReferentialValidator {
    ...
    public static func validateLinkedIDsExist(fieldName: String, referencedIDs: [String], existingIDs: Set<String>) -> [ValidationIssue] {
        referencedIDs
    ...
    public static func validateStateTransition(from: WorkflowStatus, to: WorkflowStatus, allowedTransitions: Set<WorkflowTransition>) -> ValidationIssue? {
