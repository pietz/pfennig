...
- **Begrenzte freigegebene Ergänzung (2026-09-15).** Für den lokalen Vergleich gibt es genau die Sidebar-Einträge „Buchungen“ (bestehende Live-Oberfläche) und „Designvorschau“ (isolierte native SwiftUI-Beispieldaten). Das ist keine allgemeine Neugestaltung; zusätzliche Start-, Prüf-, Chat- oder Steuerseiten bleiben ausdrücklich ungebaut.
