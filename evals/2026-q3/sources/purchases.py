...
PROFILE = {
    ...
    "address": "Kaistraße 18, 20457 Hamburg, Deutschland",
...
def footer(c: canvas.Canvas, width: float) -> None:
...
def make_software(path: Path) -> None:
    ...
    c.setAuthor("Klarquell Studio Software Ltd.")
    ...
    text(c, 48, height - 284, "VAT ID: IE0000000D", "Helvetica", 7.4, rgb("#777A87"))
    ...
    text(c, 342, height - 271, "Kaistraße 18", "Helvetica", 8.5, rgb("#4E5060"))
    ...
    text(c, 342, height - 310, "USt-ID: DE000000000", "Helvetica", 7.2, rgb("#777A87"))
    ...
    text(c, 48, height - 631, "Thank you for your business.", "Helvetica-Oblique", 8.4, rgb("#66697A"))
    footer(c, width)
    c.save()
...
def make_us_tool(path: Path) -> None:
    ...
    c.setAuthor("Northstar Dev Tools Inc.")
    ...
    text(c, 48, height - 284, "US tax ID: 00-0000000", "Courier", 7.3, grey)
...
def make_hosting(path: Path) -> None:
    ...
    c.setAuthor("Hafenblick Hosting GmbH")
    ...
    text(c, x, height - 210, "USt-ID DE000000001", "Helvetica", 7.2, slate)
    ...
    text(c, 375, height - 197, "Kaistraße 18", "Helvetica", 8.1, slate)
    ...
    text(c, 375, height - 236, "DE000000000", "Helvetica", 6.8, slate)
...
def make_receipt(path: Path) -> None:
    ...
    c.setAuthor("Papier & Punkt Fachhandel")
    ...
    centered_text(c, width / 2, height - 177, "Kaistraße 18 · 20457 Hamburg", "Courier", 6.4, ink)
    ...
    centered_text(c, width / 2, y - 16, "USt-ID DE000000003", "Courier", 5.9, muted)
...
def make_print_shop(path: Path) -> None:
    ...
    c.setAuthor("Druckwerk Nord OHG")
    ...
    text(c, x, height - 188, "USt-ID DE000000002", "Times-Roman", 6.8, muted)
    ...
    text(c, 282, height - 175, "Kaistraße 18", "Times-Roman", 7.6, muted)
    ...
    text(c, 282, height - 214, "DE000000000", "Times-Roman", 6.3, muted)
...
def make_domain(path: Path) -> None:
    ...
    c.setAuthor("Wellenfeld Domainservice GmbH")
    ...
    text(c, 52, height - 245, "USt-ID DE000000004", "Helvetica", 7.1, muted)
    ...
    text(c, 472, height - 232, "Kaistraße 18 · 20457 Hamburg, Deutschland", "Helvetica", 8.2, muted)
    text(c, 472, height - 245, PROFILE["email"], "Helvetica", 7.5, muted)
    text(c, 472, height - 258, "DE000000000", "Helvetica", 6.9, muted)
...
def make_insurance(path: Path) -> None:
    ...
    c.setAuthor("Sicherpfad Berufsschutz AG")
    ...
    text(c, 178, height - 228, "Steuernummer 000/000/00000", "Times-Roman", 7.1, muted)
    ...
    text(c, 399, height - 214, "Kaistraße 18 · 20457 Hamburg, Deutschland", "Times-Roman", 8.2, muted)
    text(c, 399, height - 227, PROFILE["email"], "Times-Roman", 7.4, muted)
    text(c, 399, height - 240, "DE000000000", "Times-Roman", 6.8, muted)
