...
def draw_invoice(doc: dict) -> None:
    ...
    pdf.drawString(sender_x, sender_y - 11, "Kaistraße 18 · 20457 Hamburg · Deutschland")
    pdf.drawString(sender_x, sender_y - 22, "hallo@studio-linden.example")
    pdf.setFont("Helvetica", 6.8)
    pdf.drawString(sender_x, sender_y - 33, "USt-ID: DE000000000")
    ...
    pdf.setFillColor(MUTED)
    pdf.setFont("Helvetica", 6.8)
    pdf.drawString(margin, 29, "Studio Linden · Mara Winter · Kaistraße 18 · 20457 Hamburg")
    pdf.showPage()
    pdf.save()
...
documents = [
    ...
    },
    {
        ...
        "notes": [
            ...
            "USt-ID des Leistungsempfängers: ATU00000000.",
        ],
