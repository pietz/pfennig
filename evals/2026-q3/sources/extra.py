...
# ///
"""Generate ten independent Q3 2026 invoices and their amount manifest."""
...
CASES = [
    ...
    dict(filename="44-rebenkontor-kundengeschenk.pdf", supplier="Rebenkontor Weinhandel GmbH", city="Hamburg, Deutschland", recipient="Mara Winter | Studio Linden", title="Rechnung", number="RK-260911-044", date="11.09.2026", item="Kundengeschenk: 2 Flaschen Riesling Spätlese", detail="Geschenkverpackung mit Karte, Versand an Jonas Brandt, Holzlinie Möbel GmbH, Bremen", net=4200, tax=798, rate="19 %", total=4998, payment="Kreditkarte 11.09.2026: 49,98 EUR", note="Grußkarte: Danke für die schöne Zusammenarbeit! Mara Winter, Studio Linden", style="catalog", scenario="client_gift_under_limit_paid", expected=dict(richtung="ausgabe", art="rechnung", datum="2026-09-11", belegnummer="RK-260911-044", gegenpartei_name="Rebenkontor Weinhandel GmbH", gegenpartei_land="DE", kategorie="geschenke", steuerbehandlung="inland", netto_cents=4200, steuer_cents=798, brutto_cents=4998, zahlungen=[dict(datum="2026-09-11", betrag=4998)])),
    dict(filename="45-hafenkorb-praesentkorb.pdf", supplier="Hafenkorb Feinkost e.K.", city="Hamburg, Deutschland", recipient="Mara Winter | Studio Linden", title="Rechnung", number="HK-2026-0918-45", date="18.09.2026", item="Präsentkorb Hanseatisch als Kundengeschenk", detail="Lieferung an Stadtfaden Verlag GmbH, Redaktion, Berlin, mit Grußkarte", net=8400, tax=588, rate="7 %", total=8988, payment="PayPal 18.09.2026: 89,88 EUR", note="Lebensmittel zu 7 % Umsatzsteuer. Grußkarte: Auf viele weitere Projekte, Studio Linden", style="catalog", scenario="client_gift_over_limit_paid", expected=dict(richtung="ausgabe", art="rechnung", datum="2026-09-18", belegnummer="HK-2026-0918-45", gegenpartei_name="Hafenkorb Feinkost e.K.", gegenpartei_land="DE", kategorie="geschenke", steuerbehandlung="inland", netto_cents=8400, steuer_cents=588, brutto_cents=8988, zahlungen=[dict(datum="2026-09-18", betrag=8988)])),
]
